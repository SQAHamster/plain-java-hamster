/**
 * This package contains a JUnit 5 extension which makes testing SimpleHamsterGames
 * easier
 * First, add the HamsterTest annotation with the correct class name
 * and extend the test class with HamsterGameResolver.
